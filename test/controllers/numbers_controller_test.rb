...
class NumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create number" do
    assert_difference('Number.count') do
      post numbers_url, params: { number: { requisition_id: @number.requisition_id, value: @number.value } }
    end
  ...
  test "should update number" do
    patch number_url(@number), params: { number: { requisition_id: @number.requisition_id, value: @number.value } }
